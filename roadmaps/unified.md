...
|---|---|---|---|
| IED | Syllabus, exam design, grading template, and Lesson 1 materials | **Nov 2, 2026** | Course start / first class Nov 3 — these four are genuinely hard against Nov 2. Lessons 2–10 are NOT part of this deadline — each is only due before its own class date (Nov 10 through Jan 29), paced alongside Valtoria negotiation time, not on a fixed weekly cadence. Syllabus blocked Sept 22–23; exam design, grading template, and Lesson 1 still need calendar blocks. Two class sections on calendar: Tuesdays split Class A Italian (8:30–11:30) / Class A English (12:00–15:00), Fridays Class B English (8:30–11:30), Nov 3 – Feb 2, "Fashion System 01–10." |
